...
def main() -> None:
    ...
    # Served as a directory so the published URL has no file extension: it goes
    # in a store listing and should outlive however this is built.
    (DIST / "privacy").mkdir()
    (DIST / "privacy" / "index.html").write_text((WEB / "privacy.html").read_text())
